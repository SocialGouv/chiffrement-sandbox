...
import { base64UrlDecode } from 'modules/crypto/codec'
import { sealBoolean, sealNumber, sealString } from 'modules/crypto/lite'
  ...
  const onSubmit = React.useCallback(
    async (values: FormValues) => {
      ...
      const res = await request<InsertResponseData>(
        'http://localhost:8080/v1/graphql', // todo: Use env
